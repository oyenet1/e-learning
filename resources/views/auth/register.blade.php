      ...
      <div class="flex flex-col overflow-y-auto">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12">
          <div class="w-full">
            ...
            <form action="{{ route('register') }}" method="post" x-data="{email: ''}">
              @csrf
              <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Name</span>
                <input name="name" value="{{ old('name') }}" class="block w-full @error('name')
                  border-red-500
                @enderror mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Jane Doe" />
                @error('name')
              ...
              <label class="block mt-4 text-sm">
                ...
                <input name="email" value="" class="block w-full cursor-not-allowed @error('email')
                  border-red-500
                @enderror mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="yourname@e-library.com" disabled>
               
                <span class="text-xs text-yellow-500 font-medium">Email is generated for you automatically</span>
               
              </label>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">Phone</span>
                <input name="phone" value="{{ old('phone') }}" class="block w-full @error('email')
                  border-red-500
                @enderror mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Jane.doe@3cyberpractitioners.com" />
                @error('phone')
                <span class="text-sm text-red-600 font-normal">{{ $message }}</span>
                @enderror
              </label>
              <label class="block mt-4 text-sm">
                ...
                <input name="password" value="{{ old('password') }}" class="block w-full @error('password')
                  border-red-500
                @enderror mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="***************" type="password" />
                @error('password')
                <span class="text-sm text-red-600 font-normal">{{ $message }}</span>
                @enderror
              </label>
              ...
              <div class="flex mt-6 text-sm">
                <label class="flex items-center dark:text-gray-400">
                  <input type="checkbox" class="text-green-600 form-checkbox focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray" />
                  <span class="ml-2">
                    I agree to the
